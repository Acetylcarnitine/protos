...
func (c *authClient) SignIn(ctx context.Context, in *SignInRequest, opts ...grpc.CallOption) (*Token, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Token)
...
func (UnimplementedAuthServer) SignIn(context.Context, *SignInRequest) (*Token, error) {
